        ...
        jdbcClient
            .sql(
                ...
                SELECT booking.id, booking.public_reference, booking.guesthouse_id,
                       ...
                       booking.adult_accommodation_total, booking.child_accommodation_total,
            ...
            .query(
                (resultSet, rowNumber) ->
                    new AdminBookingDetailView(
                        ...
                        resultSet.getBigDecimal("adult_accommodation_total"),
                        resultSet.getBigDecimal("child_accommodation_total"),

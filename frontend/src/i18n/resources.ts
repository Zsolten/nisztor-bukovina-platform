export const resources = {
  hu: {
    translation: {
      ...
      booking: {
        eyebrow: 'Foglalási kérelem · 1. lépés',
        title: 'Válassza ki a panziót',
        introduction: 'A szobatípusok, árak és szolgáltatások a kiválasztott panzióhoz igazodnak.',
        selectLegend: 'Melyik panzióban szeretne megszállni?',
        selectHint: 'A folytatáshoz válassza ki a két panzió egyikét.',
        ...
        selectedLabel: 'Kiválasztott panzió',
        roomTypes: 'Szobatípusok',
        roomCapacity: '{{count}} fő / szoba',
        prices: 'Árak',
        services: 'Szolgáltatások',
        requestNotice: 'Ez még nem végleges foglalás. A szállásadó visszaigazolja az igényt.',
  ...
  ro: {
    translation: {
      ...
      booking: {
        eyebrow: 'Cerere de rezervare · Pasul 1',
        title: 'Alegeți pensiunea',
        introduction:
          'Tipurile de camere, prețurile și serviciile se adaptează pensiunii selectate.',
        selectLegend: 'La ce pensiune doriți să vă cazați?',
        selectHint: 'Selectați una dintre cele două pensiuni pentru a continua.',
        ...
        selectedLabel: 'Pensiunea selectată',
        roomTypes: 'Tipuri de camere',
        roomCapacity: '{{count}} persoane / cameră',
        prices: 'Prețuri',
        services: 'Servicii',
        requestNotice: 'Aceasta nu este încă o rezervare finală. Gazda va confirma cererea.',
  ...
  en: {
    translation: {
      ...
      booking: {
        eyebrow: 'Booking request · Step 1',
        title: 'Choose your guesthouse',
        introduction: 'Room types, prices, and services update to match the selected guesthouse.',
        selectLegend: 'Which guesthouse would you like to stay at?',
        selectHint: 'Select one of the two guesthouses to continue.',
        ...
        selectedLabel: 'Selected guesthouse',
        roomTypes: 'Room types',
        roomCapacity: '{{count}} guests / room',
        prices: 'Prices',
        services: 'Services',
        requestNotice: 'This is not a final booking yet. The host will confirm your request.',

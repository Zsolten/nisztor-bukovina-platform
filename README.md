...
4. A foglalási e-mailek beállítását és a panziónkénti belső címzettek rögzítését a [foglalási értesítések útmutatója](docs/operations/booking-notifications.md) írja le.
